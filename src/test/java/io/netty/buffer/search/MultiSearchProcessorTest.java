...
public class MultiSearchProcessorTest {
    ...
    public void testSearchForMultiple() {
        final ByteBuf haystack = Unpooled.copiedBuffer("one two three one", StandardCharsets.UTF_8);
    ...
    public void testSearchForMultipleOverlapping() {
        final ByteBuf haystack = Unpooled.copiedBuffer("abcd", StandardCharsets.UTF_8);
        final int length = haystack.readableBytes();
    ...
    public void findLongerNeedleInCaseOfSuffixMatch() {
        final ByteBuf haystack = Unpooled.copiedBuffer("xabcx", StandardCharsets.UTF_8);
