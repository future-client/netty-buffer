...
public class SearchProcessorTest {
    ...
    public void testSearch(Algorithm algorithm) {
        final ByteBuf haystack = Unpooled.copiedBuffer("abc☺", StandardCharsets.UTF_8);
    ...
    public void testRepeating(Algorithm algorithm) {
        final ByteBuf haystack = Unpooled.copiedBuffer("abcababc", StandardCharsets.UTF_8);
    ...
    public void testOverlapping(Algorithm algorithm) {
        final ByteBuf haystack = Unpooled.copiedBuffer("ababab", StandardCharsets.UTF_8);
        final int length = haystack.readableBytes();
    ...
    private SearchProcessorFactory factory(Algorithm algorithm, String needle) {
        return factory(algorithm, needle.getBytes(StandardCharsets.UTF_8));
    }
